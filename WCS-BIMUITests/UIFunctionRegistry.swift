...
enum UIFunctionRegistry {
  ...
  static let all: [Entry] = [
    ...
    Entry(id: "site.location.modePicker", area: .site, description: "Location input mode"),
    Entry(id: "site.location.locatorHeader", area: .site, description: "Locator status header"),
    Entry(id: "site.location.liveMap", area: .site, description: "Live locator map"),
    Entry(id: "site.location.gpsIndicator", area: .site, description: "GPS signal indicator"),
    Entry(id: "site.location.searchField", area: .site, description: "Address search field"),
    Entry(id: "site.location.searchButton", area: .site, description: "Address search button"),
    Entry(id: "site.location.searchResult", area: .site, description: "Search result row"),
    Entry(id: "site.location.manualAddress", area: .site, description: "Manual address field"),
    Entry(id: "site.location.manualLatitude", area: .site, description: "Manual latitude field"),
    Entry(id: "site.location.manualLongitude", area: .site, description: "Manual longitude field"),
    Entry(id: "site.location.manualApply", area: .site, description: "Apply manual location"),
    Entry(id: "site.location.autoValuationToggle", area: .site, description: "Auto-valuation toggle"),
    Entry(id: "site.location.runValuation", area: .site, description: "Run site valuation"),
    Entry(id: "site.location.valuationValue", area: .site, description: "Valuation amount"),
    Entry(id: "project.overview.valuation", area: .projects, description: "Overview valuation"),
    // AR
